...
#Save figure
plt.savefig(path_figures + "Figure_14.png", dpi=dpi, transparent=False, bbox_inches='tight')
...
x = df3['longitude'].values
y = df3['latitude'].values
u = df3['glorys_u'].values
v = df3['glorys_v'].values
...
ax.set_extent(extents)
ax.coastlines(resolution='10m',zorder=2)
# cb = plt.colorbar(ax.pcolormesh(x, y, speed, cmap='coolwarm', transform=ccrs.PlateCarree()), pad = 0.1)
# cb.set_label('m/s', size = 12, rotation = 0, labelpad = 15)
ax.quiver(x, y, u/r, v/r, speed,
                 cmap="plasma_r",
...
#Save figure
plt.savefig(path_figures + "ocean_velocity.png", dpi=dpi, transparent=False, bbox_inches='tight')
